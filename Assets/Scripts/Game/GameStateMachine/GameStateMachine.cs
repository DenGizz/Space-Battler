...
namespace Assets.Scripts.Game.GameStateMachine
{
    public class GameStateMachine : StateMachine.StateMachine
    {
        ...
        public GameStateMachine(ISpaceShipFactory spaceShipFactory, 
            ...
            ScenesConfig scenesConfig, ISceneLoader sceneLoader, IUIFactory uiFactory, IBattleFactory battleFactory, IStaticDataService staticDataService)
        {
            ...
            States[typeof(CreateBattleState)] = new CreateBattleState(this, spaceShipFactory,battleUIService,battleFactory, staticDataService);
